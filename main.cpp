...
Output: will print the room text to the console and also prompt user for certain interactions in the rooms. There is also an enemy to fight if they come across it.
